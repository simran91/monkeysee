...
func main() {
	...
	sourceFiles := []string{"rgb.png", "rgb.jpg", "rgb.gif", "forest.png", "flower.jpg"}
...
func runMod(modfunc func(string, string, mimage.ImageMatrix) mimage.ImageMatrix,
	destDir, destFileInit string, colourMatrix mimage.ImageMatrix, vars ...interface{}) {
...
// mod: SwapRGBtoGBR
//
func modSwapRGBtoGBR(destDir, destFileInit string, colourMatrix mimage.ImageMatrix) mimage.ImageMatrix {
...
//
func modGreyscaleAverageWithTranslusence(destDir, destFileInit string, colourMatrix mimage.ImageMatrix) mimage.ImageMatrix {
...
// mod: Blur
//
func modBlur(destDir, destFileInit string, colourMatrix mimage.ImageMatrix) mimage.ImageMatrix {
	blurAmount := 8
...
//
func modBlurWithKernelMethod(destDir, destFileInit string, colourMatrix mimage.ImageMatrix) mimage.ImageMatrix {
	blurAmount := 8
...
// mod: modGaussianBlur
//
func modGaussianBlur(destDir, destFileInit string, colourMatrix mimage.ImageMatrix) mimage.ImageMatrix {
...
// mod: modAverageBlur
//
func modAverageBlur(destDir, destFileInit string, colourMatrix mimage.ImageMatrix) mimage.ImageMatrix {
